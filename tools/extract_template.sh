...
xgettext *.php */*.php --copyright-holder='Positions Development Team' --package-name='GLPI - Positions plugin' --package-version='4.4.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
