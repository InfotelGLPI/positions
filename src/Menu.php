...
class Menu extends CommonGLPI
{
    ...
    **/
    static function getMenuContent()
    {
        ...
        $menu['links']['search']                        = Position::getSearchURL(false);

        $menu['options']['positions']['links']['search'] = Position::getSearchURL(false);
        ...
        if (Position::canCreate()) {
            $menu['links']['add']                        = Position::getFormURL(false);
            $menu['options']['positions']['links']['add'] = Position::getFormURL(false);
